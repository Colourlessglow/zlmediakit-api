...
data class AddStreamProxyRequest(
    ...
    val enableHls: Boolean? = null,
    /**
     * 是否转换成 hls-fmp4 协议
     */
    @SerialName("enable_hls_fmp4")
    val enableHlsFmp4: Boolean? = null,
    /**
     * 是否允许 mp4 录制
     */
    @SerialName("enable_mp4")
    val enableMp4: Boolean? = null,
    /**
     * 是否转 rtsp 协议
     */
    @SerialName("enable_rtsp")
    val enableRtsp: Boolean? = null,
    /**
     * 是否转 rtmp/flv 协议
     */
    @SerialName("enable_rtmp")
    val enableRtmp: Boolean? = null,
    /**
     * 是否转 http-ts/ws-ts 协议
     */
    @SerialName("enable_ts")
    val enableTs: Boolean? = null,
    /**
     * 是否转 http-fmp4/ws-fmp4 协议
     */
    @SerialName("enable_fmp4")
    val enableFmp4: Boolean? = null,
    /**
     * 转协议是否开启音频
     */
    ...
    val addMuteAudio: Boolean? = null,
    /**
     * mp4录制保存根目录，置空使用默认目录
     */
    @SerialName("mp4_save_path")
    val mp4SavePath: String? = null,
    /**
     * mp4录制切片大小，单位秒
     */
    @SerialName("mp4_max_second")
    val mp4MaxSecond: Int? = null,

    /**
     * hls保存根目录，置空使用默认目录
     */
    @SerialName("hls_save_path")
    val hlsSavePath: String? = null,
